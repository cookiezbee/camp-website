...
export default function Home() {
	return (
		<>
			...
			<main className="flex flex-col items-center p-12 gap-8 bg-gray-200">
				<Image src="/vercel.svg" alt="Логотип" width={200} height={100} />

				<p className="text-lg text-gray-700 max-w-2xl text-center">
					Погрузись в мир веб-разработки! Мы научим тебя создавать современные
					сайты с нуля, используя самые востребованные технологии.
				</p>
